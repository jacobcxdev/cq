...
func TestNewProxyCodexNativeHTTPInstallsForEnforcementAndRetainedAuthority(t *testing.T) {
	...
	receipts, err := proxy.NewCodexTurnReceiptStore(strings.NewReader(strings.Repeat("r", 32)), time.Now)
	if err != nil {
