...
var commandDispatcherSpecs = []commandDispatcherSpec{
	...
	{"proxy_leases.go", "runProxyLeasesWithDependencies", "args[0]", "proxy leases"},
	...
	{"proxy_commands.go", "validProxyLeaseArguments", "argv[0]", "proxy leases"},
...
var commandDispatcherCoverageOnly = []commandDispatcherCoverage{
	...
	{commandDispatcherKey{"proxy.go", "runProxy", "args[1]"}, []string{"invalidate"}},
