...
func TestModelMaxInputTokens(t *testing.T) {
	tests := []struct {
		...
		// Effort-suffix strings are NOT stripped; they are distinct unknown models.
		{name: "effort suffix not stripped - xhigh", model: "gpt-5.4-xhigh", want: 0},
		{name: "effort suffix not stripped - o-series", model: "o4-mini-high", want: 0},
	}
